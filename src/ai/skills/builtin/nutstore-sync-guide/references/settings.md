...
| Key                             | Type                                                                     | Notes                                                                                                                          |
| ------------------------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| `filterRules`                   | object `{ rules: [...] }`                                                | Max 200 rules. Each rule: `expr` (non-empty glob string), `type` (`include` or `exclude`), optional `caseSensitive` (boolean). |
...
| `configDirSyncMode`             | one of `none`, `bookmarks`, `all`                                        |                                                                                                                                |
